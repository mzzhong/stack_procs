...
def estimateOffsetField(reference, secondary, inps=None):
    ...
    # starting pixel
    objOffset.referenceStartPixelDownStatic = inps.startpixeldw if inps.startpixeldw != -1 else margin
    objOffset.referenceStartPixelAcrossStatic = inps.startpixelac if inps.startpixelac != -1 else margin

    #objOffset.referenceStartPixelDownStatic = inps.startpixeldw if inps.startpixeldw != -1 else margin + objOffset.halfSearchRangeDown
    #objOffset.referenceStartPixelAcrossStatic = inps.startpixelac if inps.startpixelac != -1 else margin + objOffset.halfSearchRangeAcross
