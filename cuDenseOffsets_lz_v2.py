...
def estimateOffsetField(reference, secondary, inps=None):
    ...
    # Explanation for the default setting
    #   margin                      margin + halfsearch         margin + halfsearch + halfwin
    #   secondary start             reference start             win center

    # Explanation for the my conventional setting
    #   margin - halfsearch         margin                      margin + halfwin
    #   secondary start             reference start             win center

    # Explanation for the DenseAmpcor.py, limit_setting_option = 1
    #   margin                  margin + halfsearch             margin + halfsearch + halfwin 
    #   secondary start         reference start                 win center
